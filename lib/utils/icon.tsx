...
export function XIcon({ className, size = 18 }: SocialIconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
      className={cn("fill-current shrink-0 size-auto", className)}
      style={{
        width: `${size}px`,
        height: `${size}px`,
        minWidth: `${size}px`,
...
export function FacebookIcon({ className, size = 18 }: SocialIconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
export function InstagramIcon({ className, size = 18 }: SocialIconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
export function YouTubeIcon({ className, size = 18 }: SocialIconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
export function TikTokIcon({ className, size = 18 }: SocialIconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
export function WhatsAppIcon({ className, size = 18 }: SocialIconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
export const icons = {
  ...
  close: XMarkIcon, // ❌
  x: XIcon, // X logo
  facebook: FacebookIcon, // Facebook logo
  instagram: InstagramIcon, // Instagram logo
  linkedin: LinkedInIcon, // LinkedIn logo
  youtube: YouTubeIcon, // YouTube logo
  tiktok: TikTokIcon, // TikTok logo
  whatsapp: WhatsAppIcon, // WhatsApp logo
