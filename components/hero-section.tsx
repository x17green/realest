  ...
  return (
    <section className="relative w-full h-96 bg-gradient-to-r from-slate-900 to-slate-800 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200&h=400&fit=crop')",
        }}
      />

      <div className="relative z-10 container h-full flex flex-col items-center justify-center gap-8 px-4">
        <div className="text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-2">Find Your Perfect Property</h1>
          <p className="text-lg text-gray-200">No Duplicates, Only Verified Listings</p>
        </div>
